...
Formatting Examples:
1. Set column width
2. Add vertical and horizontal alignment
3. Set color
4. Add bold text
5. Set font
=cut

$sheet1->set_column('A:E',15);
my $format = $workbook->add_format(valign=>'vcenter'); $workbook->add_format(align=>'center');
$format->set_color('blue');
$format->set_bold();
$format->set_font('Arial');

$sheet1->write(0, 0, "0", $format);
$sheet1->write(0, 1, "1");
$sheet1->write(1, 0, "2");
$sheet1->write(1, 1, "3", $format);
